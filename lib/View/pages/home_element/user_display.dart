                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("المستخدم", style: Text_Style().StyleFount(
                              size: 22,
                              fountFamily: "body",
                              color: Colors.black),),

                          Text("كلمه السر", style: Text_Style().StyleFount(
                              size: 22,
                              fountFamily: "body",
                              color: Colors.black),),

                          if(size_phone.width! > 850) Text("تاريخ انشاء الحساب",
                            style: Text_Style().StyleFount(size: 22,
                                fountFamily: "body",
                                color: Colors.black),),

                          Text("", style: Text_Style().StyleFount(size: 20,
                              fountFamily: "body",
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              Text(data['email'], style: Text_Style().StyleFount(
                  size: 16, fountFamily: "tahome", color: Colors.white),),
              VerticalDivider(),
              // display==false?TextButton(onPressed: () {
              //   setState(() {display==false?display=true:display=false;});
              // }, child: Text("عرض")):
              // Text(data['password'], style: Text_Style().StyleFount(
              //     size: 20, fountFamily: "body", color: Colors.white),),
           Tooltip(
             ...
             message:data['password'] ,
              ...
              VerticalDivider(),
              if(size_phone.width! > 850)Text(data['date'],
                style: Text_Style().StyleFount(
                    size: 20, fountFamily: "body", color: Colors.white),),
              if(size_phone.width! > 850)
                VerticalDivider(),
              Customer_config.CustomerButton("حذف",
                  Colors.white, Colors.black, size_phone.defualtsize! * 2,
                  size_phone.defualtsize! * 3.5, () {
                    Auth_Controller().deleteUser(
                        snapshots.data!.docs[index].id, context);
                  })
            ],
          ),
        );
